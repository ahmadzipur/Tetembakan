...
namespace InfimaGames.LowPolyShooterPack
{
	...
	public sealed class Character : CharacterBehaviour
	{
		...
		[Tooltip("Kamera Normal.")]
		[SerializeField]
		private Camera cameraWorld;

		[Header("Animasi")]

		[Tooltip("Menentukan tingkat kehalusan transisi animasi pergerakan.")]
		[SerializeField]
		private float dampTimeLocomotion = 0.15f;

		[Tooltip("Mengatur kehalusan transisi membidik. Perlu diperhatikan karena pengaturan ini berdampak pada banyak aspek.")]
		[SerializeField]
		private float dampTimeAiming = 0.3f;
		
		[Header("Animasi berbasis prosedur")]
		
		[Tooltip("Animator untuk Karakter.")]
		[SerializeField]
