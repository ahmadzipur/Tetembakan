...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class CharacterKinematics : MonoBehaviour
    {
        ...
        [Header("Pengaturan Lengan Kiri")]
        
        [Tooltip("Target Lengan Kiri. Menentukan target IK yang digunakan.")]
        [SerializeField] 
        private Transform armLeftTarget;

        [Range(0.0f, 1.0f)]
        [Tooltip("Bobot Inverse Kinematics untuk lengan kiri.")]
        [SerializeField]
        ...
        [Tooltip("Hierarki Lengan Kiri: Root, Mid, Tip.")]
        [SerializeField]
        private Transform[] armLeftHierarchy;
        
        [Header("Pengaturan Lengan Kanan")]
        ...
        [Range(0.0f, 1.0f)]
        [Tooltip("Bobot Inverse Kinematics untuk lengan kanan.")]
        [SerializeField]
        ...
        [Tooltip("Hierarki Lengan Kanan: Root, Mid, Tip.")]
        [SerializeField]
