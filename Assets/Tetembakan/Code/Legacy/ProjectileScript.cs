...
public class ProjectileScript : MonoBehaviour {
	...
	[Tooltip("Aktifkan untuk menggunakan gaya konstan, bukan hanya gaya saat peluncuran.")]
	public bool useConstantForce;
	[Tooltip("Seberapa cepat proyektil bergerak")]
	public float constantForceSpeed;
	[Tooltip("Berapa lama setelah muncul proyektil akan menghancurkan dirinya sendiri")]
	public float explodeAfter;
	private bool hasStartedExplode;

	private bool hasCollided;

	[Header("Prefabs Ledakan")]
	//Explosion prefab
	public Transform explosionPrefab;

	[Header("Opsi Kustomisasi")]
	//Force added at start
	[Tooltip("Initial launch force")]
	public float force = 5000f;
	//Time before the projectile is destroyed
	[Tooltip("Berapa lama setelah muncul objek proyektil harus dihancurkan")]
	...
	[Tooltip("Intensitas ledakan")]
	public float power = 250.0F;

	[Header("Proyektil Peluncur Roket")]
	[Tooltip("Aktifkan jika proyektil menggunakan efek partikel")]
	public bool usesParticles;
	public ParticleSystem smokeParticles;
	public ParticleSystem flameParticles;
	[Tooltip("Menambahkan jeda agar efek partikel selesai diputar, " +
