...
public class Projectile : MonoBehaviour {
	...
	[Range(5, 100)]
	[Tooltip("Waktu sebelum prefab peluru dihancurkan.")]
	public float destroyAfter;
	[Tooltip("Jika diaktifkan, peluru akan hancur saat mengenai target.")]
	public bool destroyOnImpact = false;
	[Tooltip("Waktu minimum setelah benturan sebelum peluru dihancurkan")]
	public float minDestroyTime;
	[Tooltip("Waktu maksimum setelah benturan sebelum peluru dihancurkan")]
	public float maxDestroyTime;

	[Header("Prefab Efek Tumbukan")]
