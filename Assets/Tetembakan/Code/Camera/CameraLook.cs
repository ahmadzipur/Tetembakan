...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class CameraLook : MonoBehaviour
    {
        ...
        [Tooltip("Sensitivitas pergerakan kamera.")]
        [SerializeField]
        private Vector2 sensitivity = new Vector2(1, 1);

        [Tooltip("Batas sudut rotasi vertikal minimum dan maksimum kamera.")]
        [SerializeField]
        private Vector2 yClamp = new Vector2(-60, 60);

        [Tooltip("Mengaktifkan interpolasi pada rotasi pandangan.")]
        [SerializeField]
        private bool smooth;

        [Tooltip("Kecepatan interpolasi rotasi pandangan.")]
        [SerializeField]
